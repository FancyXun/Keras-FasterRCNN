...
def InceptionResnetV2_model(input_shape, include_top=False, input_tensor=None, weights='imagenet', pooling=None):
    ...
    branch_0 = conv2d_bn(x, 256, 1, name='Reduction_B_block' + '_conv1')
    branch_0 = conv2d_bn(branch_0, 384, 3, strides=2, padding='valid', name='Reduction_B_block' + '_conv2')
    branch_1 = conv2d_bn(x, 256, 1, name='Reduction_B_block' + '_conv3')
    branch_1 = conv2d_bn(branch_1, 288, 3, strides=2, padding='valid', name='Reduction_B_block' + '_conv4')
    branch_2 = conv2d_bn(x, 256, 1, name='Reduction_B_block' + '_conv5')
    branch_2 = conv2d_bn(branch_2, 288, 3, name='Reduction_B_block' + '_conv6')
    branch_2 = conv2d_bn(branch_2, 320, 3, strides=2, padding='valid', name='Reduction_B_block' + '_conv7')
    branch_pool = layers.MaxPooling2D(3, strides=2, padding='valid')(x)
    branches = [branch_0, branch_1, branch_2, branch_pool]
