...
def rpn_anchor_gt(all_img_data, img_length_calc_function):
    ...
    for img_data in all_img_data:
        ...
        img_data1, x_img = read_img(img_data)
        (width, height) = (img_data1['width'], img_data1['height'])
        ...
        try:
            ...
            y_rpn_cls, y_rpn_regr = calc_rpn(img_data1, width, height, resized_width, resized_height,
        ...
        return np.copy(x_img), [np.copy(y_rpn_cls), np.copy(y_rpn_regr)], img_data1
